...
**Date:** 2025-10-26T14:33:34+00:00
**Cluster:** nyu-devops
**Namespace:** default
...
promotions-deployment-8b467dd9b-g2wr7   1/1     Running   0          26s   10.42.3.3   k3d-nyu-devops-agent-1   <none>           <none>
```

### Service
```
NAME                 TYPE        CLUSTER-IP     EXTERNAL-IP   PORT(S)   AGE   SELECTOR
promotions-service   ClusterIP   10.43.233.38   <none>        80/TCP    26s   app=promotions
```

### Ingress
```
NAME                 CLASS     HOSTS              ADDRESS                            PORTS   AGE
promotions-ingress   traefik   promotions.local   172.19.0.2,172.19.0.3,172.19.0.4   80      26s
```
...
```
NAME                 CLASS     HOSTS              ADDRESS                            PORTS   AGE
promotions-ingress   traefik   promotions.local   172.19.0.2,172.19.0.3,172.19.0.4   80      26s_DESCR
```
...
Date: Sun, 26 Oct 2025 14:33:34 GMT
Server: gunicorn
